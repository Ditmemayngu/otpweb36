...
def generate_two_cross_domain():
    ...
    Admin bấm tạo email:
    - Tạo 2 email random
    - Random xen kẽ trong 6 domain
    - Mỗi lần tạo lấy 2 domain khác nhau, không trùng nhau
    """
    ...
    <div class="box admin-only">
        ...
        {% if admin %}
            ...
            <p class="small">
                ...
                Mỗi lần tạo lấy 2 domain khác nhau trong danh sách 6 domain, không trùng nhau.
            </p>
